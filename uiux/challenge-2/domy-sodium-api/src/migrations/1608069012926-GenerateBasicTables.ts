...
export class GenerateBasicTables1608069012926 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "pioneers_status_enum" AS ENUM('active', 'approved', 'deleted', 'pending')`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TYPE "pioneers_status_enum"`);
